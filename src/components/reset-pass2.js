...
const ResetPassword2 = () => {
  return (
    <div className="resetPass2-main login-main">
      ...
      <div className="all-cards bg-light d-flex justify-content-center">
        <Form className="form-card reset-card forgot2-card col-lg-9">
          ...
          <div className="input-code d-flex justify-content-evenly">
          <FormGroup className="input-box">
            <Label for="exampleEmail" hidden>Email</Label>
            <Input className="form-input" id="exampleEmail" name="email" placeholder="" type="email" />
          </FormGroup>
          <FormGroup className="input-box">
            <Label for="exampleEmail" hidden>Email</Label>
            <Input className="form-input" id="exampleEmail" name="email" placeholder="" type="email" />
